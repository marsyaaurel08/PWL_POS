    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/supplier/'.$supplier->supplier_id) }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="text" class="form-control" id="supplier_kode" name="supplier kode"
             ...
             <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="text" class="form-control" id="supplier_nama" name="supplier nama"
             ...
             <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="text" class="form-control" id="supplier_alamat" name="supplier alamat"
