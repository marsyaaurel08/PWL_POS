        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                <div class="row mb-2">
                    <div class="col-md-4">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="penjualan_kode" id="penjualan_kode" class="form-control form-control-sm">
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="pembeli" id="pembeli" class="form-control form-control-sm" maxlength="50" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" value="{{ Auth::user()->nama }}" class="form-control form-control-sm" readonly>
                ...
                <div class="bg-light rounded p-3 mb-3 border">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4 mb-2">
                            ...
                            <select id="add_barang_id" class="form-control form-control-sm">
                                <option value="" disabled selected>- Pilih Barang -</option>
                                @foreach ($barang as $b)
                                    <option value="{{ $b->barang_id }}" data-nama="{{ $b->barang_nama }}" data-kode="{{ $b->barang_kode }}" data-harga="{{ $b->harga_jual }}">
                        ...
                        <div class="form-group col-md-3 mb-2">
                            <label>Harga</label>
                            <input type="number" id="add_harga" class="form-control form-control-sm" readonly>
                        </div>
                        <div class="form-group col-md-3 mb-2">
                            <label>Jumlah</label>
                            <input type="number" id="add_jumlah" class="form-control form-control-sm" min="1" value="1">
                        </div>
                        <div class="form-group col-md-2 mb-2 d-flex align-items-end">
                            <button type="button" id="btn-add-item" class="btn btn-sm btn-success w-100">Tambah</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <small id="error-items" class="text-danger"></small>
                </div>
            </div>

            <div class="modal-footer p-2">
                <button type="button" data-dismiss="modal" class="btn btn-sm btn-warning">Batal</button>
